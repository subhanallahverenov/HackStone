        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed text-brand-200">
              SynAIpse Bank is a demonstration project. Not a real financial institution. Branding is original and inspired by, but not copied from, well-known banks.
            </p>
          </div>
        </div>
        <div className="border-t border-white/10 py-4 text-center text-xs text-brand-200">
          © {new Date().getFullYear()} SynAIpse Bank. All rights reserved.
        </div>
      </footer>
    </div>
  )
