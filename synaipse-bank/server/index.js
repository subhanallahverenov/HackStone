...
if (fs.existsSync(distDir)) {
  ...
  app.get("/", (req, res) =>
    res.json({
      message: "SynAIpse Bank API is running. The frontend is served after `npm run build`. In dev, open http://localhost:5173",
    }),
  )
}
